...
if (corp == tax):
    print ('Choose either filing a income tax return as a corporate or as an individual')
elif (corp > tax):
    print ('Individual tax rate is the best method as the taxable income would be reduced by NZD %d' %difftax)
elif (corp < tax):
    print ('Corporate tax rate is the best method as the taxable income would be reduced by NZD %d' % difftax) 
